  ...
  const data = [
    {
      ...
      description: `As a Frontend Developer, I create engaging and user-friendly interfaces using,Next-js, HTML, CSS, and JavaScript. My expertise includes building responsive designs and optimizing web performance,  to deliver seamless user experiences.`,
...

    {
      ...
      description: `With a strong foundation in JavaScript programming, I wrote effective code for the solution. My experience includes Object-Oriented Design, Data Structures, and Algorithms, enabling me to build scalable and maintainable software solutions.`,
